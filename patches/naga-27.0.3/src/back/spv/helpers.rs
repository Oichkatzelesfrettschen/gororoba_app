...
impl crate::AddressSpace {
    pub(super) const fn to_spirv_semantics_and_scope(
        ...
        // Backport from naga 28.0.0: emit relaxed (empty) memory semantics
        // for all address spaces.  naga 27 incorrectly set UNIFORM_MEMORY /
        // WORKGROUP_MEMORY bits without a non-relaxed ordering, violating
        // VUID-StandaloneSpirv-MemorySemantics-10871.  Removing the storage-
        // class bits makes the semantics purely relaxed, which is valid.
        match self {
